...
<script type="text/javascript">
	function ConfirmDel(){
	   var	Name = document.getElementById("RoleNo").value;
	   if(Name==null || Name==""){
	   		alert("请选择需要删除的角色。");
	   		return false;
	   }else{
   		if(confirm("您确定要删除本角色？删除后不可恢复！"))
    		return true;
  		else
     		return false;
	   }
	...
	<body>
		<center>
			<div class="form">
				...
				<form action="delRole.action" class="niceform" method="post" onsubmit="return ConfirmDel();">
					<fieldset>
						<dl>
							<dt>
								<label>
						...
						<dl>
							...
							<div align="left">
							<dd>
								<select id="RoleNo" size="1" name="RoleNo" style="width: 300px;" onfocus="getselSysRole();">
									<!-- 加载系统角色 -->		
                            	</select>&nbsp;<span style="color: red">*</span>
							</dd>
							</div>
						...
						<dl>
							<input type="submit" value="角色删除">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input value="重新选择" type="button" onclick="javascript:ResetRoleSel();">
						</dl>

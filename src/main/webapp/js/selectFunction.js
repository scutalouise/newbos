...
dTree.prototype.node = function(node, nodeId) {
	...
	}		if(this.config.useCheckBox && nodeId!=0){		str+='<input type="checkbox" name="dTreeChk" style="VERTICAL-ALING: middle; width: 11px; height: 11px;" id="'		+node.id+"-"+node.pid+'" onclick=selChildNode("'+node.id+"-"+node.pid+'") />'	}
	if (node.url) {
